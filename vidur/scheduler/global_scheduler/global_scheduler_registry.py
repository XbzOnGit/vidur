...
from vidur.scheduler.global_scheduler.locality_global_scheduler import LocalityGlobalScheduler
...
GlobalSchedulerRegistry.register(GlobalSchedulerType.LOCALITY, LocalityGlobalScheduler)